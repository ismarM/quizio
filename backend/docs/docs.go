...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/httpapi.ImageUploadRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/httpapi.ImageResponse"
                        }
                    },
                    "400": {
        ...
        "/api/users/{userId}/open-sessions": {
            "get": {
        ...
        "/api/users/{userId}/quizzes/{quizId}/attempts/finish": {
            "post": {
